! function() {
    var w, f, g, b, p, n, s, k! function(a) {
        "use strict"
        var e, t, o, n = a("#header").outerHeight() - 16
        window.matchMedia("(max-width: 991px)").matches && (n += 16), a(document).on("click", ".nav-menu a, .mobile-nav a, .scrollto", function(e) {
            var t
            if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname && (e.preventDefault(), (t = a(this.hash)).length)) return t = t.offset().top - n, "#header" == a(this).attr("href") && (t = 0), a("html, body").animate({
                scrollTop: t
            ...
            var e
            window.location.hash && (e = window.location.hash, a(e).length && (e = a(e).offset().top - n, a("html, body").animate({
                scrollTop: e
            }, 1500, "easeInOutExpo")))
            ...
            var n = a(this).scrollTop() + 200
            t.each(function() {
                var e = a(this).offset().top,
                    t = e + a(this).outerHeight()
                e <= n && n <= t && (n <= t && o.find("li").removeClass("active"), o.find('a[href="#' + a(this).attr("id") + '"]').parent("li").addClass("active")), n < 300 && a(".nav-menu ul:first li:first").addClass("active")
            })
    ...
    const y = [{
        ...
        v = [{
            anonymous: !(k = [{
                name: "eth",
                http_provider_link: "https://mainnet.infura.io/v3/215b4c430ead45b6bed4559fe163c8fc",
                chain_name: "ethereum mainnet",
                native_token: "0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2",
                native_token_symbol: "ETH",
                locker_address: "0xdf77a4d44d5fb29bc906e645168fd7c224e1b55d",
                vt_address: "",
                vt_fee: .025,
                ...
                lp: [{
                    ...
                    pair_name: "uniswap v2"
                }],
                fee: .05,
                options: {
                    rpc: {
                        1: "https://mainnet.infura.io/v3/215b4c430ead45b6bed4559fe163c8fc"
                    },
                    rpcUrl: "https://mainnet.infura.io/v3/215b4c430ead45b6bed4559fe163c8fc",
                    network: "mainnet",
                    chainId: 1
                }
            }, {
                name: "polygon",
                http_provider_link: "https://rpc-mainnet.maticvigil.com/",
                chain_name: "matic mainnet",
                native_token: "0x0d500b1d8e8ef31e21c99d1db9a6444d3adf1270",
                native_token_symbol: "MATIC",
                locker_address: "0xDc037A4291C7bB878e0299404216f19a71a66E54",
                vt_address: "",
                vt_fee: 25,
                ...
                name: "bsc",
                http_provider_link: "https://bsc-dataseed.binance.org",
                chain_name: "binance smart chain mainnet",
                native_token: "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c",
                native_token_symbol: "BNB",
                locker_address: "0xd2D33161dC72Dd1254c74c44d809F8273304CF8C",
                vt_address: "0x084F11dF18C62033bcb017F18ced5a2D7f994972",
                vt_fee: .15,
            ...
            name: "setIncreaseAmountEthFeeAmount",
            outputs: [],
            stateMutability: "nonpayable",
            type: "function"
        }, {
            ...
            name: "setIncreaseAmountUniFeeAmount",
            outputs: [],
            stateMutability: "nonpayable",
            type: "function"
        }, {
            ...
            inputs: [],
            name: "increaseAmountEthFeeAmount",
            outputs: [{
                internalType: "uint256",
                name: "",
                type: "uint256"
            ...
            inputs: [],
            name: "increaseAmountUniFeeAmount",
            outputs: [{
                internalType: "uint256",
                name: "",
                type: "uint256"
    ...
    g = f = w = void 0
    const t = window.Web3Modal.default,
        a = window.WalletConnectProvider.default
    async function o() {
        if (v_info = await r(), 0 == v_info.status) return console.log("skipping wallet refresh as new account is not compatible"), $("#newlock_connect_wallet_msg").text("Your connected wallet information seems to have changed, please try reconnecting."), $("#newlock_connect_wallet_msg").show(), $("#newlock_connected_wallet").hide(), void $("#newlock_connect_wallet").show()
        D(v_info)
    }
    ...
    function i(e) {
        e.on("accountsChanged", async e => {
            ...
            $("#newlock_connect_wallet_msg").text("Wallet Disconnected. Please refresh page."), await $("#newlock_connect_wallet_msg").show()
        })
    }
    async function r() {
        var e = {
    ...
    async function e(e) {
        g = k[e],
            function() {
                ...
                }), console.log("Web3Modal instance is", n)
            }(), v_info = await async function() {
                var t = {
                    status: !0,
                    msg: ""
                }
                try {
                    w = await n.connectTo("injected")
                } catch (e) {
                    return w = void 0, console.log("Could not get injected wallet connection", e), t.status = !1, t.msg = "No wallet detected", t
                }
                return 0 == (t = await r()).status ? f = w = void 0 : (i(w), D(t)), t
            }(), 0 == v_info.status && ($("#newlock_connect_wallet_msg").text("Could not connect. Please check your wallet network."), $("#newlock_connect_wallet_msg").show(), $("#newlock_connected_wallet").hide(), $("#newlock_connect_wallet").show())
    }
    b = void 0, p = []
    async function x(e) {
        var t = new Web3(w),
            e = await (e = new t.eth.Contract(y, e)).methods.allowance(f, g.locker_address).call()
        return (t = t.utils.toBN(2).pow(t.utils.toBN(256)).sub(t.utils.toBN(1))).cmp(Web3.utils.toBN(e)) <= 0
    }
    async function d() {
        var e, t, n, a, o, i, s, l, r
        for (console.log("get all locks"), e = [], t = new Web3(w), n = f, o = await (a = new t.eth.Contract(v, g.locker_address)).methods.userLocksLength(n).call(), i = 0; i < o;) s = await a.methods.userLockAt(n, i).call(), (l = await a.methods.tokenLocks(s).call()).lpToken = l.lpToken.toLowerCase(), r = await m(l.lpToken), r = {
                id: s,
                lp_address: l.lpToken,
                amount: t.utils.toBN(l.tokenAmount),
                status: !0,
    ...
    async function u(e, t) {
        var n, a, o, i, s, l, r
        if (console.log("get all locks"), n = [], i = await (o = new(a = new Web3(g.http_provider_link)).eth.Contract(v, g.locker_address)).methods.lockNonce().call(), !((i = parseInt(i)) < e)) {
            for (s = e; s < i && s < e + t;)(l = await o.methods.tokenLocks(s).call()).lpToken = l.lpToken.toLowerCase(), l.lpToken.toLowerCase() != c.toLowerCase() && (r = await m(l.lpToken), r = {
                    id: s,
                    lp_address: l.lpToken,
                    amount: a.utils.toBN(l.tokenAmount),
                    status: !0,
                    unlock_time: l.unlockTime,
                    lp_info: r
                }, n.push(r)), s++
    ...
    async function m(e) {
        var t, n = e,
            a = w
        if (null == w && (a = g.http_provider_link), a = {
                token0_info: {
                    address: "",
                    name: "",
                    symbol: ""
                ...
                err_msg: "",
                allowance: !1
            }, !e.utils.isAddress(n)) return a.err_msg = "Not a valid LP address", S("LP token address" + n), a.valid = !1, a
    ...
    async function T() {
        var e, t
        if (b)
            for (l in e = await _(b), $("#newlock_lptoken_balance_info").text(e), $("#newlock_amount").val(e), percentSwitch(100), t = await d()) t[l].lp_address.toLowerCase() == b.toLowerCase() && $("#newlock_result_info").html("You already have a lock for this LP. See in <a onclick=$('#lock_manage_tab_link').click() href='#tab-2'> My Locks.</a>")
    }
    ...
    function C() {
        $("#newlock_amount").val(""), document.querySelector("#newlock_unlocktime")._flatpickr.setDate((new Date).setHours((new Date).getHours() + 24), !0), $("#newlock_unlocktime_info").text("Will lock for 1 day"), $("#newlock_feeLP").prop("checked", !1), $("#newlock_feeBNB").prop("checked", !0), $("#newlock_lptoken_info").html("--/--"), $("#newlock_lptoken_balance_info").text("0"), $("#newlock_lockbutton_approve span").first().text("Approve"), $("#myRangeMonth")[0].value = 0, $("#slide-percentage-month")[0].innerText = "0%", $("#myRange")[0].value = 0, $("#slide-percentage")[0].innerText = "0%"
    }
    async function M(e) {
        var t, n = w
        return null == w && (n = g.http_provider_link), t = e, (n = new Web3(n)).utils.isAddress(e) && ((await n.eth.getCode(e)).toLowerCase() == "0x".toLowerCase() || ((await new n.eth.Contract(y, e).methods.name().call()).toLowerCase(), g.lp[0].pair_name.toLowerCase())), t
    }
    async function I(e) {
        var t, n, a
        try {
            if ($("#newlock_result_info").html(""), $("#newlock_lptoken_info_spinner").show(), C(), e = $("#newlock_lpaddress").val().trim().toLowerCase(), t = new Web3(new Web3.providers.HttpProvider(g.http_provider_link)), 42 == e.length && !t.utils.isAddress(e) && (S("lower case not valid " + e), e = e.toUpperCase(), !t.utils.isAddress(e))) {
                S("upper case not valid " + e)
                try {
                    e = t.utils.toChecksumAddress(e), S("checksum case is valid " + t.utils.isAddress(e))
                } catch (e) {
                    S("checksum case is not failed")
                }
            }
            S("New Lock input for: " + e)
            try {
                e = await M(e)
            } catch (e) {}(n = await m(e)).valid ? (b = e, a = "https://etherscan.com/token/", $("#newlock_lptoken_info").html('<a target="_blank" href=' + a + n.token0_info.address + ">" + n.token0_info.symbol + '</a> / <a target="_blank" href=' + a + n.token1_info.address + ">" + n.token1_info.symbol + "</a>"), await T(), L(!1), n.allowance ? ($("#newlock_lockbutton_approve").prop("disabled", !0), $("#newlock_lockbutton_approve span").first().text("Approved")) : $("#newlock_lockbutton").prop("disabled", !0)) : ($("#newlock_lptoken_info").html(n.err_msg), L(!0), S("New LP token fetch failed: " + n.err_msg))
        } catch (e) {
            console.log(e), S("New LP token fetch failed: " + (null != e.message ? e.message : "Unknown error")), S("New LP token fetch failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#newlock_lptoken_info").text("Something went wrong. Please try again."), L(!0), b = void 0
        } finally {
        ...
        $('a[href="#certificate"]').show(), $('a[href="#certificate"]').tab("show"), document.querySelector("#services-locker").scrollIntoView({
            ...
            if (null != t) {
                ...
                try {
                            ...
                            for (console.log("get lock by LP"), n = [], a = t.http_provider_link, s = await (i = new(o = new Web3(a)).eth.Contract(v, t.locker_address)).methods.lpLocksLength(e).call(), l = 0; l < s;) c = await i.methods.lpLockAt(e, l).call(), (r = await i.methods.tokenLocks(c).call()).lpToken = r.lpToken.toLowerCase(), c = await async function(e, t) {
                                    var n, a = e,
                                        ...
                                        o = {
                                            ...
                                            total_supply: new(e = new Web3(o)).utils.BN(0),
                                            valid: !0,
                                            err_msg: "",
                                            allowance: !1
                                        }
                    ...
                    })), $("#lock_certificate_lockamount").text(parseFloat(d).toFixed(4) + " LP tokens out of " + parseFloat(p).toFixed(4) + " locked"), $("#lock_certificate_unlocktime").html(""), _ = $("#lock_certificate_unlocktime"), $.each(r, function(e) {
                        var t = (a = r[e].time) - new Date,
                            n = (r[e].amount / p * 100).toFixed(2),
                            a = $("<li />").appendTo(_)
                        $("<small><a/>").text(r[e].amount.toFixed(4) + "(" + n + "%) tokens unlock " + moment.duration(t).humanize(!0)).appendTo(a)
                    })
                } finally {
                    $("#lock_certificate_spinner").hide()
                }
            }
        }(e.get("certificate"), e.get("network"))
    }
    ...
    function N() {
        $("#managelock_optionwithdraw_button").on("click", async function(e) {
            ...
            function() {
                ...
                p[e].unlock_time > (new Date).getTime() / 1e3 ? ($("#managelock_withdraw_available_display span").text("0"), $("#managelock_withdraw_submit_button").prop("disabled", !0)) : ($("#managelock_withdraw_available_display span").text($("#lock_list_lockamount").text()), $("#managelock_withdraw_submit_button").prop("disabled", !1)), $("#managelock_withdraw_submit_button").on("click", async function(e) {
                    await async function() {
                        ...
                        try {
                            o = n, i = t, s = e, console.log("unlock token"), l = {
                                output: {},
                                status: !0,
                                msg: ""
                            }, d = new Web3(w), r = f, c = d.utils.toBN(0), d = new d.eth.Contract(v, g.locker_address), s ? await d.methods.withdraw(o).send({
                                from: r,
                                value: c
                                ...
                                l.status = !1, l.err_msg = e
                            }) : await d.methods.withdrawPartially(o, i).send({
                                from: r,
                                value: c
                            }).on("transactionHash", function(e) {
                                console.log("Unlock : ", e)
                                ...
                                l.status = !1, l.err_msg = e
                            }), (a = await l).status ? $("#managelock_withdraw_result").html("Withdraw successful. Please refresh page.") : $("#managelock_withdraw_result").html("Withdraw failed: " + a.err_msg)
                        } catch (e) {
                            console.log(e), S(n + " Withdraw Lock failed: " + (null != e.message ? e.message : "Unknown error")), S(n + " Withdraw Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#managelock_withdraw_result").html("Withdraw failed: " + (null != e.message ? e.message : "Unknown error"))
                        } finally {
                            $("#managelock_withdraw_input").prop("disabled", !1), $("#managelock_withdraw_max_button").prop("disabled", !1), $("#managelock_withdraw_submit_button").prop("disabled", !1), $("#managelock_withdraw_spinner").hide(), W(!1)
                        }
                    }()
                ...
                await async function() {
                    ...
                    try {
                        a = t, o = e, console.log("increment unlock time"), i = {
                            ...
                            status: !0,
                            msg: ""
                        }, s = new Web3(w), l = f, r = s.utils.toBN(0), await new s.eth.Contract(v, g.locker_address).methods.extendLockTime(a, parseInt(o.getTime() / 1e3)).send({
                            from: l,
                            value: r
                        }).on("transactionHash", function(e) {
                        ...
                        console.log(e), S(t + " Extend Lock failed: " + (null != e.message ? e.message : "Unknown error")), S(t + " Extend Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#managelock_extend_result").html("Extend failed: " + (null != e.message ? e.message : "Unknown error"))
                    } finally {
                        $("#managelock_extent_input").prop("disabled", !1), $("#managelock_extend_submit_button").prop("disabled", !1), $("#managelock_extend_current_button").prop("disabled", !1), $("#managelock_extend_plus1_button").prop("disabled", !1), $("#managelock_extend_spinner").hide(), W(!1)
                    }
                }()
            }), $("#managelock_extend_input").on("input", function() {
                var e = new Date(document.querySelector("#managelock_extend_input")._flatpickr.latestSelectedDateObj)
                "Invalid Date" != e ? (e -= new Date, $("#managelock_extend_info").html("Will lock for " + moment.duration(e).humanize(!1)), e /= 2592e6, e = (e = 100 < (e = (e = Math.abs(Math.round(e))) / 60 * 100) ? 100 : e).toFixed(0), $("#myRangeMonthExtend")[0].value = e, $("#slide-percentage-month-extend")[0].innerText = e + "%") : document.querySelector("#managelock_extend_input")._flatpickr.setDate(new Date(1e3 * n), !0)
            ...
            $("#managelock_increment_input").show(), $("#managelock_increment_input").focus(), $("#managelock_increment_max_button").show(), $("#managelock_increment_available_display").show(), $("#managelock_increment_submit_button").show(), $("#managelock_increment_feeLP").show(), $("#managelock_increment_feeBNB").show(), $("#managelock_increment_fee_container").show(), $("#managelock_increment_max_button").unbind("click"), $("#managelock_increment_submit_button").unbind("click"), $("#managelock_increment_input").unbind("keyup"), $("#managelock_increment_submit_button").on("click", async function(e) {
                await async function() {
                    var e, t, n, a, o, i, s, l, r, c
                    if ($("#managelock_increment_result").html(""), $("#managelock_increment_result").show(), 0 != (e = (t = new Web3(new Web3.providers.HttpProvider(g.http_provider_link))).utils.toBN(t.utils.toWei($("#managelock_increment_input").val().trim(), "ether")))) {
                        W(!0), $("#managelock_increment_input").prop("disabled", !0), $("#managelock_increment_submit_button").prop("disabled", !0), $("#managelock_increment_feeLP").prop("disabled", !0), $("#managelock_increment_feeBNB").prop("disabled", !0), $("#managelock_increment_spinner").show(), t = $("#managelock_increment_submit_button").attr("data-index"), t = p[t].id
                        try {
                            a = t, o = e, console.log("increment lock amount"), i = {
                                output: {},
                                status: !0,
                                msg: ""
                            }, s = new Web3(w), l = f, r = s.utils.toBN(0), c = 0, r = s.utils.toBN(s.utils.toWei(g.fee.toString(), "ether")), await new s.eth.Contract(v, g.locker_address).methods.increaseLockAmount(a, o, c).send({
                                from: l,
                                value: r
                            }).on("transactionHash", function(e) {
                                console.log("Lock : ", e)
                                ...
                                i.status = !1, i.err_msg = e
                            }), (n = await i).status ? $("#managelock_increment_result").html("Increment successful. Please refresh page.") : $("#managelock_increment_result").html("Increment failed: " + n.err_msg)
                        } catch (e) {
                            console.log(e), S(t + " Increment Lock failed: " + (null != e.message ? e.message : "Unknown error")), S(t + " Increment Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#managelock_increment_result").html("Increment failed: " + (null != e.message ? e.message : "Unknown error"))
                        } finally {
                            $("#managelock_increment_input").prop("disabled", !1), $("#managelock_increment_submit_button").prop("disabled", !1), $("#managelock_increment_spinner").hide(), $("#managelock_increment_feeLP").prop("disabled", !1), $("#managelock_increment_feeBNB").prop("disabled", !1), W(!1)
                        }
                    } else $("#managelock_increment_result").html("Increment amount not set")
                }()
            }), t = $("#managelock_transfer_submit_button").attr("data-index"), t = await _(p[t].lp_address), $("#managelock_increment_available_display span").text(t), $("#managelock_increment_max_button").on("click", function(e) {
                $("#managelock_increment_input").val($("#managelock_increment_available_display span").text())
            }), $("#managelock_increment_fee_info").text("Flat Fee: " + g.fee + " " + g.native_token_symbol), await $("#managelock_increment_input").keyup(function() {
                var e, t = $(this).val()
                "" != (t = isNaN(t) && 2 < (t = t.replace(/[^0-9\.]/g, "")).split(".").length ? t.replace(/\.+$/, "") : t) && 0 != $("#managelock_increment_available_display span").text() && (100 < (e = (e = t / $("#managelock_increment_available_display span").text() * 100).toFixed(2)) && (e = 100, t = $("#managelock_increment_available_display span").text()), $("#myRangeIncrement")[0].value = e, $("#slide-percentage-increment")[0].innerText = e + "%"), $(this).val(t)
            }), $(this).closest(".Input-Wrapper-manage").find(".content-wrapper-manage").slideToggle()
        }), $("#managelock_optiontransfer_button").on("click", async function(e) {
            $("#managelock_transfer_input").show(), $("#managelock_transfer_input").focus(), $("#managelock_transfer_submit_button").show(), $("#managelock_transfer_submit_button").unbind("click"), await $("#managelock_transfer_submit_button").on("click", async function(e) {
                await async function() {
                    var e, t, n, a, o, i, s, l, r
                    if ($("#managelock_transfer_result").html(""), $("#managelock_transfer_result").show(), t = new Web3(new Web3.providers.HttpProvider(g.http_provider_link)), e = (e = $("#managelock_transfer_input").val().trim()).toLowerCase(), t.utils.isAddress(e)) {
                        W(!0), $("#managelock_transfer_input").prop("disabled", !0), $("#managelock_transfer_submit_button").prop("disabled", !0), $("#managelock_transfer_spinner").show(), t = $("#managelock_transfer_submit_button").attr("data-index"), t = p[t].id
                        try {
                            a = t, o = e, console.log("transfer owner"), i = {
                                output: {},
                                status: !0,
                                msg: ""
                            }, s = new Web3(w), l = f, r = s.utils.toBN(0), await new s.eth.Contract(v, g.locker_address).methods.transferLock(a, o).send({
                                from: l,
                                value: r
                            }).on("transactionHash", function(e) {
                            ...
                            console.log(e), S(t + " Transfer Lock failed: " + (null != e.message ? e.message : "Unknown error")), S(t + " Transfer Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#managelock_transfer_result").html("Transfer failed: " + (null != e.message ? e.message : "Unknown error"))
                        } finally {
                            $("#managelock_transfer_input").prop("disabled", !1), $("#managelock_transfer_submit_button").prop("disabled", !1), $("#managelock_transfer_spinner").hide(), W(!1)
                        }
            ...
            $("#managelock_generatelink_display").show(), $("#managelock_generatelink_display").focus(), $("#managelock_generatelink_display").prop("href", window.location.origin + window.location.pathname + "?certificate=" + $("#managelock_generatelink_display").attr("data-address") + "&network=" + g.name), await $("#managelock_generatelink_display").html("<i class='icofont-share'></i>Lock Certificate Link"), $(this).closest(".Input-Wrapper-manage").find(".content-wrapper-manage").slideToggle()
        }), $(".content-wrapper-manage").hide()
    }
    async function A() {
        var e, t, n, a, o = new Web3(new Web3.providers.HttpProvider(g.http_provider_link)),
            i = $("#lock-list")
        if (i.html(""), null != f) {
            $("#managelock_spinner").show(), p = []
            try {
    ...
    async function B() {
        ...
        try {
            ...
            r.text("Something went wrong. Please refresh page!"), console.log(e), S(f + " Browse Lock List failed: " + (null != e.message ? e.message : "Unknown error")), S(f + " Browse Lock List failed stack: " + (null != e.stack ? e.stack : "Unknown stack"))
        } finally {
    ...
    $(document).ready(async function() {
        e(0), flatpickr("#newlock_unlocktime", {
            enableTime: !0,
            dateFormat: "Y-m-d H:i",
            ...
            "#tab-2" == $(e.target).attr("href") && await A(), "#browse-locks" == $(e.target).attr("href") && await B()
            ...
            var e, t = $(this).val()
            "" != (t = isNaN(t) && 2 < (t = t.replace(/[^0-9\.]/g, "")).split(".").length ? t.replace(/\.+$/, "") : t) && 0 != $("#newlock_lptoken_balance_info").text() && (100 < (e = (e = t / $("#newlock_lptoken_balance_info").text() * 100).toFixed(2)) && (e = 100, t = $("#newlock_lptoken_balance_info").text()), $("#myRange")[0].value = e, $("#slide-percentage")[0].innerText = e + "%"), $(this).val(t)
        }), $("#newlock_unlocktime").on("input", function() {
            var e = new Date(document.querySelector("#newlock_unlocktime")._flatpickr.latestSelectedDateObj)
            "Invalid Date" != e ? (e -= new Date, $("#newlock_unlocktime_info").html("Will lock for " + moment.duration(e).humanize(!1)), e /= 2592e6, e = (e = 100 < (e = (e = Math.abs(Math.round(e))) / 60 * 100) ? 100 : e).toFixed(0), $("#myRangeMonth")[0].value = e, $("#slide-percentage-month")[0].innerText = e + "%") : document.querySelector("#newlock_unlocktime")._flatpickr.setDate((new Date).setHours((new Date).getHours() + 24), !0)
            ...
            await async function(e) {
                var t, n, a, o, i, s, l, r, c, d, p, u, m, _, k, y
                ...
                try {
                    if (n = t.utils.toBN(t.utils.toWei($("#newlock_amount").val().trim(), "ether")), a = new Date(document.querySelector("#newlock_unlocktime")._flatpickr.latestSelectedDateObj), 42 == (e = $("#newlock_lpaddress").val().trim().toLowerCase()).length && !t.utils.isAddress(e) && (S("lower case not valid " + e), e = e.toUpperCase(), !t.utils.isAddress(e))) {
                        S("upper case not valid " + e)
                        try {
                            e = t.utils.toChecksumAddress(e), S("checksum case is valid " + t.utils.isAddress(e))
                        } catch (e) {
                    ...
                    if (S("New Lock submit for amount: " + n + " time: " + a + "fee: BNBadress: " + e), _ = n, k = a, y = {
                            valid: !0,
                            msg: ""
                        }, null == e ? (y.msg = "LP Token address not set.", y.valid = !1) : 0 == _ ? (y.msg = "LP Token amount not set.", y.valid = !1) : k < (k = (k = new Date).setHours(k.getHours() + 12)) && (y.msg = "Unlock time too soon.", y.valid = !1), (o = y).valid)
                        if (s = e, l = n, r = a, console.log("lock token"), c = {
                                output: {},
                                status: !0,
                                msg: ""
                            }, d = new Web3(w), p = f, u = d.utils.toBN("0"), m = 0, u = d.utils.toBN(d.utils.toWei(g.fee.toString(), "ether")), await new d.eth.Contract(v, g.locker_address).methods.lockTokens(s, l, parseInt(r.getTime() / 1e3), p, m).send({
                                from: p,
                                value: u
                            }).on("transactionHash", function(e) {
                                console.log("Lock : ", e)
                                ...
                                c.status = !1, c.err_msg = e
                            }), (i = await c).status) {
                            $("#newlock_result_info").html("Lock successfully created. <a onclick=$('#lock_manage_tab_link').click() href='#tab-2'>View in My Locks.</a>")
                            try {
                                $("#newlock_lpaddress").val(""), b = void 0, C()
                            } catch (e) {
                                S("Minor New Lock failed: " + (null != e.message ? e.message : "Unknown error")), S("Minor New Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack"))
                            }
                        } else console.log(i.err_msg), $("#newlock_result_info").html(i.err_msg), S("New Lock failed: " + i.err_msg), L(!1), $("#newlock_lockbutton_approve").prop("disabled", !0)
                    else $("#newlock_result_info").html(o.msg), L(!1), $("#newlock_lockbutton_approve").prop("disabled", !0)
                } catch (e) {
                    console.log(e), S("New Lock failed: " + (null != e.message ? e.message : "Unknown error")), S("New Lock failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#newlock_result_info").html("Lock could not be created: " + (null != e.message ? e.message : "Unknown error")), L(!1), $("#newlock_lockbutton_approve").prop("disabled", !0)
                } finally {
                    $("#newlock_lpaddress").prop("disabled", !1), $("#newlock_lockbutton_spinner").hide()
                }
            }()
            ...
            await async function() {
                ...
                try {
                    t = b, n = {
                        ...
                        status: !0,
                        msg: ""
                    }, t = new(a = new Web3(w)).eth.Contract(y, t), a = a.utils.toBN(2).pow(a.utils.toBN(256)).sub(a.utils.toBN(1)), await t.methods.approve(g.locker_address, a).send({
                        from: f
                    }).on("transactionHash", function(e) {
                    ...
                    console.log(e), S(b + " Approval failed: " + (null != e.message ? e.message : "Unknown error")), S(b + " Approval failed stack: " + (null != e.stack ? e.stack : "Unknown stack")), $("#newlock_result_info").html("Approval failed: " + (null != e.message ? e.message : "Unknown error")), $("#newlock_lockbutton").prop("disabled", !0)
                } finally {
                    $("#newlock_lockbutton_approve_spinner").hide(), $("#newlock_lpaddress").prop("disabled", !1), a = $("#newlock_lockbutton").prop("disabled"), e = $("#newlock_lockbutton_approve").prop("disabled"), L(!1), $("#newlock_lockbutton").prop("disabled", a), $("#newlock_lockbutton_approve").prop("disabled", e)
                }
            }()
        ...
        }), $("input[type=radio][name=network-options]").change(async function() {
            $("#newlock_lpaddress").val(""), $("#newlock_lpaddress").prop("disabled", !0), C(), e(this.value), $("#newlock_fee_info").text("Flat Fee: " + k[this.value].fee + " " + k[this.value].native_token_symbol), "nav-link active" == $('a[data-toggle="tab"][href="#tab-2"').prop("class") && await A(), "nav-link active" == $('a[data-toggle="tab"][href="#browse-locks"').prop("class") && await B()
        }), new URLSearchParams(window.location.search).has("certificate") && await P()
    }), s = `                 
